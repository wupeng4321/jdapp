...
@class JDFooterLoadingView, JDShopCommonErrorView, JDStoreNetwork, NSMutableArray, NSString, UIImageView, UILabel, UITableView, UITapGestureRecognizer, UIView, UIWebView;
@protocol JDActivityViewControllerDelegate;
...
@interface JDActivityViewController : JDViewController <JDShopCommonErrorViewDelegate, UITableViewDelegate, UITableViewDataSource>
{
    ...
    NSString *ruleText;
    NSString *domId;
    id <JDActivityViewControllerDelegate> _delegate;
    NSString *_ruleName;
...
@property(nonatomic) _Bool isTemplateFloor; // @synthesize isTemplateFloor=_isTemplateFloor;
...
@property(retain, nonatomic) NSMutableArray *totalAry; // @synthesize totalAry=_totalAry;
@property(retain, nonatomic) NSString *ruleName; // @synthesize ruleName=_ruleName;
@property(nonatomic) id <JDActivityViewControllerDelegate> delegate; // @synthesize delegate=_delegate;
