...
@class FinderVideoBuyAVPlayer, JDImageView, NSString, SHAVErrorTipView, SHAVFinishedView, SHAVReplayBar, SHAVToastView, SHAVTopInfoView, UIButton, UITapGestureRecognizer;
@protocol VBVideoViewDelegate;

@interface FinderVideoBuyListVideoView : UIView <VBVideoViewProtocol>
{
...
@property(retain, nonatomic) SHAVReplayBar *controlView; // @synthesize controlView=_controlView;
