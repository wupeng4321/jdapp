...
- (id)textWithPrice:(id)arg1 precision:(long long)arg2 leftFont:(long long)arg3 rightFont:(long long)arg4 deleteIcon:(_Bool)arg5 iconFont:(long long)arg6;
...
- (void)setPrice:(id)arg1 withPrecision:(long long)arg2 isZeroValidated:(_Bool)arg3 currencySymbol:(_Bool)arg4;
- (void)setPrice:(id)arg1 withPrecision:(long long)arg2 leftFont:(long long)arg3 rightFont:(long long)arg4 iconFont:(long long)arg5;
