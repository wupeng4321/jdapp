...
@class JDWebView, JDWebViewController, NSArray, NSDictionary, NSString;
@protocol JDReactWebViewDelegate, JDWebViewWkSwitchProvider;

@interface JDReactWebView : RCTView <JDWebViewDelegate, RCTAutoInsetsProtocol>
{
    JDWebViewController *_webViewVC;
    JDWebView *_webView;
    ...
    id <JDReactWebViewDelegate> _delegate;
...
@property(nonatomic) __weak id <JDReactWebViewDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
