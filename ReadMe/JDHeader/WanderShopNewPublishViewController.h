...
#import "WanderShopPublishTitleViewDelegate-Protocol.h"
#import "WanderShopTextViewDelegate-Protocol.h"

@class JDBaseToastView, NSIndexPath, NSMutableArray, NSString, UILabel, UITableView, UITableViewCell, UIView, WanderShopCircleModel, WanderShopPublishProductIconView, WanderShopPublishTextView, WanderShopPublishTitleView;

@interface WanderShopNewPublishViewController : JDViewController <UITableViewDataSource, UITableViewDelegate, UITextViewDelegate, WanderShopTextViewDelegate, WanderShopPublishTitleViewDelegate, JDBaseToastViewDelegate>
{
