...
@interface ScanSearchResultErrorCell : UITableViewCell <HomePageChannelDisplayItem, HomePageChannelInteractiveItem>
{
    UIImageView *_icon;
    UILabel *_textTips;
...
@property(nonatomic) __weak UILabel *textTips; // @synthesize textTips=_textTips;
