...
#import "FinalSearchHistoryHotItemsViewDelegate-Protocol.h"

@class FSSearchHistoryHotItemsView, NSArray, NSIndexPath, NSString, UIButton, UILabel, UIPanGestureRecognizer, UIView;
@protocol FinalSearchListHistoryViewCellDelegate;

@interface FSSearchListHistoryViewCell : UITableViewCell <FinalSearchHistoryHotItemsViewDelegate>
{
    ...
    FSSearchHistoryHotItemsView *_hotItemView;
    UIView *_mainView;
...
@property(retain, nonatomic) FSSearchHistoryHotItemsView *hotItemView; // @synthesize hotItemView=_hotItemView;
