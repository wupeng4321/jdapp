...
@class CBCertInfoModel, JDPayActiveInfoModel, NSString;

@interface CBBankCardInfoModel : JDPayModel
{
    _Bool _isHolderName;
    _Bool _isIdCard;
    _Bool _isCVV;
    ...
    JDPayActiveInfoModel *_activeInfoModel;
...
@property(retain, nonatomic) JDPayActiveInfoModel *activeInfoModel; // @synthesize activeInfoModel=_activeInfoModel;
@property(nonatomic) _Bool isNewCardActive; // @synthesize isNewCardActive=_isNewCardActive;
