...
@class JDButton, JDIconLabel, JDImageView, JDPriceLabel, MyStowModel, MyStowPromotionView, NSMutableDictionary, NSString, UIButton, UIFont, UIImageView, UILabel, UITapGestureRecognizer, UIView;
...
@interface MyStowCell : UITableViewCell
{
    ...
    UIView *functionView;
    JDButton *m_reduceNotiBtn;
    JDButton *arrivalNoticeBtn;
    JDButton *similarGoods;
    ...
    JDIconLabel *installmentLabel;
    _Bool isUsebyStage;
    UILabel *icon3PriceLabel;
    JDIconLabel *icon3IconLabel;
    JDIconLabel *installServiceLabel;
    _Bool isPriceDown;
    _Bool isLastCell;
...
@property(retain, nonatomic) MyStowModel *model; // @synthesize model=model_;
...
- (void)layoutSubviews;
- (void)hideLabelsForInstallmentLabel;
- (void)configInstallServicelabel:(id)arg1;
- (void)configPlusIcon:(id)arg1;
- (void)configInstallmentLabelWithDic:(id)arg1;
