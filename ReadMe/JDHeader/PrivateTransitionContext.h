...
@interface PrivateTransitionContext : NSObject <UIViewControllerContextTransitioning>
{
    ...
    NSDictionary *_privateViewControllerViews;
...
@property(retain, nonatomic) NSDictionary *privateViewControllerViews; // @synthesize privateViewControllerViews=_privateViewControllerViews;
