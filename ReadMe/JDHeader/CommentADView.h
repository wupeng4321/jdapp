...
@class CacheNetworkManager, CommentHomeTempateModel, JDPageControl, JDStoreNetwork, NSArray, NSString, NSTimer, iCarousel;
@protocol CommentAdViewDelegate;

@interface CommentADView : JDContentItem <iCarouselDataSource, iCarouselDelegate>
{
    ...
    NSArray *_data;
    id <CommentAdViewDelegate> _adviewDelegate;
    CommentHomeTempateModel *templateModel;
}

@property(retain, nonatomic) CommentHomeTempateModel *templateModel; // @synthesize templateModel;
@property(nonatomic) id <CommentAdViewDelegate> adviewDelegate; // @synthesize adviewDelegate=_adviewDelegate;
