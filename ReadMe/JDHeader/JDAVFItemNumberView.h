...
@class JDScrollTextField, NSString, UIButton, UILabel;
@protocol JDAVFItemNumberViewDelegate;

@interface JDAVFItemNumberView : UIView <UITextFieldDelegate>
{
    id <JDAVFItemNumberViewDelegate> _mDelegate;
    UILabel *_countLabel;
...
@property(copy, nonatomic) NSString *mCount; // @synthesize mCount=_mCount;
...
@property(nonatomic) __weak id <JDAVFItemNumberViewDelegate> mDelegate; // @synthesize mDelegate=_mDelegate;
- (void).cxx_destruct;
