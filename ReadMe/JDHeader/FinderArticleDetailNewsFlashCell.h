...
@interface FinderArticleDetailNewsFlashCell : JDFinderTableViewCell
{
    CDUnknownBlockType _clickFlashBlock;
...
@property(copy, nonatomic) CDUnknownBlockType clickFlashBlock; // @synthesize clickFlashBlock=_clickFlashBlock;
- (void).cxx_destruct;
- (void)clickFlashRecognizer:(id)arg1;
