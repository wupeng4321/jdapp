...
@class CALayer, HMScrollView, NSArray, NSDictionary, NSString, UIColor;
@protocol HMSegmentedControlDelegate;

@interface HMSegmentedControl : UIControl <UIScrollViewDelegate>
{
    _Bool _titleSizeIgnoreSelected;
    _Bool _userDraggable;
    _Bool _touchEnabled;
    _Bool _verticalDividerEnabled;
    _Bool _stretchSegmentsToScreenSize;
    ...
    id <HMSegmentedControlDelegate> _eventDelegate;
...
@property(nonatomic) __weak id <HMSegmentedControlDelegate> eventDelegate; // @synthesize eventDelegate=_eventDelegate;
...
@property(nonatomic, getter=shouldStretchSegmentsToScreenSize) _Bool stretchSegmentsToScreenSize; // @synthesize stretchSegmentsToScreenSize=_stretchSegmentsToScreenSize;
...
@property(nonatomic) double textImageSpacing; // @synthesize textImageSpacing=_textImageSpacing;
...
@property(nonatomic) _Bool titleSizeIgnoreSelected; // @synthesize titleSizeIgnoreSelected=_titleSizeIgnoreSelected;
