...
@interface JDPaymentCodeFillViewController : JDPFullScreenScrollViewController <UIScrollViewDelegate, JDPDatePickerViewDelegate, UITextFieldDelegate, JDPPickerViewDelegate>
{
