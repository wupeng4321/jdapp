...
@class JDButton, JDStoreNetwork, NSMutableAttributedString, NSMutableDictionary, NSString, NSTimer, NewRecommendUITableView, UIButton, UIImageView, UILabel, UIView;
...
@interface JDMobileOrderDetailViewController : JDViewController <JDBaseToastViewDelegate, RecommendUITableViewDataSource, RecommendUITableViewDelegate>
{
    ...
    _Bool hasHiddenNoticeView;
    JDButton *buyOrPayBtn;
    UILabel *numberLabel;
    JDStoreNetwork *net_;
