...
@class JDImageView, NSString, TTTPlusPriceView, TTTPriceCentreView, TTTWareModel, TTTWaresBeltView, TTTWaresMarkView, UIImageView, UILabel;
...
- (void).cxx_destruct;
- (struct CGRect)plusPriceViewFrame;
