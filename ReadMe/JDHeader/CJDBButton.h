...
@class JDBBadgeItem, JDBCustomActivityIndicatorView, NSString;

@interface CJDBButton : UIButton
{
    JDBBadgeItem *_badgeItem;
    JDBCustomActivityIndicatorView *_activityView;
    NSString *_url;
    NSString *_badgeUrl;
