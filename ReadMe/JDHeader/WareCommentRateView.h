...
@class NSArray, NSMutableArray, UIImage, UIPanGestureRecognizer, UITapGestureRecognizer;
@protocol WareCommentRateViewDelegate;

@interface WareCommentRateView : UIView
{
    ...
    int _minRating;
    NSArray *_imageArray;
    id <WareCommentRateViewDelegate> _delegate;
}
...
@property(nonatomic) __weak id <WareCommentRateViewDelegate> delegate; // @synthesize delegate=_delegate;
