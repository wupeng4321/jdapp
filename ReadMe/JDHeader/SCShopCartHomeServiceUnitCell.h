...
@class NSMutableArray, SCShopCartHomeServiceSkuModel;

@interface SCShopCartHomeServiceUnitCell : UICollectionViewCell
{
    _Bool _shouldSelected;
    SCShopCartHomeServiceSkuModel *_unitItem;
...
@property(retain, nonatomic) SCShopCartHomeServiceSkuModel *unitItem; // @synthesize unitItem=_unitItem;
