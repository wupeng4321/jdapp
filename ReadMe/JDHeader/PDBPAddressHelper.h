...
@class JDAddressView, JDStoreNetwork, NSDictionary, NSMutableArray, NSMutableDictionary, NSString, PDBPContainerDataModel, PDBPStockInfoModel, PDCaptchaServiceComponent;

@interface PDBPAddressHelper : NSObject <JDAddressViewDelegate, JDAddressViewDataSource, JDCommonAddressViewDataSource, JDCommonAddressViewDelegate>
{
    _Bool _popForOldAddress;
    NSMutableDictionary *location_;
    PDBPContainerDataModel *_model;
    PDBPStockInfoModel *_stockInfo;
    long long _tab;
...
@property(retain, nonatomic) PDBPStockInfoModel *stockInfo; // @synthesize stockInfo=_stockInfo;
...
- (void)closePopupViewMTA;
- (void)floorTappedMTA:(id)arg1;
...
- (id)getAddressString;
- (void)popAddressViewForOldAddressMTA;
