...
@class FinderArticleDetailBottomIconModel, FinderInventoryDetailIconModel, FinderTabBarShareItemModel, FinderTabBarStoreItemModel, NSArray, NSString;
...
@interface FinderInventoryDetailListModel : NSObject
{
    ...
    long long _hasStore;
    NSString *_style;
    FinderInventoryDetailIconModel *_detailIconModel;
...
@property(retain, nonatomic) FinderInventoryDetailIconModel *detailIconModel; // @synthesize detailIconModel=_detailIconModel;
