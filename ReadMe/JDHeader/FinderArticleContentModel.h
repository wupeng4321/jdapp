...
@interface FinderArticleContentModel : FinderContentModel <NSCoding>
{
    _Bool _hasLiked;
    FinderJumpModel *_jump;
    FinderJumpModel *_authorPageJump;
    FinderJumpModel *_jumpChannel;
...
@property(retain, nonatomic) FinderJumpModel *jumpChannel; // @synthesize jumpChannel=_jumpChannel;
