...
@class JDSHTTPBodyPart, NSEnumerator, NSError, NSMutableArray, NSMutableData, NSOutputStream, NSString;
@protocol NSStreamDelegate;

@interface JDSMultipartBodyStream : NSInputStream <NSCopying, NSStreamDelegate>
{
    ...
    JDSHTTPBodyPart *_currentHTTPBodyPart;
...
@property(retain, nonatomic) JDSHTTPBodyPart *currentHTTPBodyPart; // @synthesize currentHTTPBodyPart=_currentHTTPBodyPart;
