...
@class CAGradientLayer, JDSHNavMenuView, NSString, UIButton, UIImageView, UILabel;

@interface MessageSubBigCell : MessageCenterCell <JDBaseToastMenuViewDataSource, JDBaseToastMenuViewDelegate>
{
    UIButton *_topBtn;
    UIButton *_botBtn;
