...
#import "JDSURLSessionManager.h"

#import "NSCopying-Protocol.h"
#import "NSSecureCoding-Protocol.h"

@class JDSHTTPRequestSerializer, JDSHTTPResponseSerializer, NSURL;
@protocol JDSURLRequestSerialization, JDSURLResponseSerialization;

@interface JDSHTTPSessionManager : JDSURLSessionManager <NSSecureCoding, NSCopying>
{
    NSURL *_baseURL;
    JDSHTTPRequestSerializer<JDSURLRequestSerialization> *_requestSerializer;
}

+ (_Bool)supportsSecureCoding;
+ (id)manager;
@property(retain, nonatomic) JDSHTTPRequestSerializer<JDSURLRequestSerialization> *requestSerializer; // @synthesize requestSerializer=_requestSerializer;
...
@property(retain, nonatomic) JDSHTTPResponseSerializer<JDSURLResponseSerialization> *responseSerializer; // @dynamic responseSerializer;
