...
@class CBCaptchaView, JDPAttributedLabel, NSString, UIButton, UIImageView;
@protocol JDPayMemberCodeVerifyProtocol;

@interface JDPayMemberCodeSMSViewController : JDPPartBaseViewController <CBCaptchaViewDelegate, JDPAttributedLabelDelegate>
{
    NSString *_message;
