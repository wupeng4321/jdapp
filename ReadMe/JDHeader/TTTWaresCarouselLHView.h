...
#import "TTTWaresLHItemDelegate-Protocol.h"

@class NSAttributedString, NSString, TTTFloorModel, TTTWaresCycleScrollView, UILabel;

@interface TTTWaresCarouselLHView : TTTBaseView <TTTWaresCycleScrollViewDelegate, TTTWaresCycleScrollViewDataSource, TTTWaresLHItemDelegate, TTTBaseViewProtocol>
{
