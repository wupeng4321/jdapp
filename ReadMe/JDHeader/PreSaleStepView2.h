...
@class COCheckoutPreSalePaymentInfoModel, JDButton, NSString;
...
@interface PreSaleStepView2 : UIView
{
    JDButton *_checkBox;
    _Bool _isCheckBox;
    COCheckoutPreSalePaymentInfoModel *_preSaleModel;
...
@property(retain, nonatomic) COCheckoutPreSalePaymentInfoModel *preSaleModel; // @synthesize preSaleModel=_preSaleModel;
- (void).cxx_destruct;
