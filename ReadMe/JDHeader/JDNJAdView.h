...
@class CacheNetworkManager, JDNJHomeTempateModel, JDPageControl, JDStoreNetwork, NSArray, NSString, NSTimer, iCarousel;
...
@interface JDNJAdView : JDContentItem <iCarouselDataSource, iCarouselDelegate>
{
    ...
    NSArray *_data;
    id <JDNJAdViewDelegate> _adviewDelegate;
    JDNJHomeTempateModel *templateModel;
}

@property(retain, nonatomic) JDNJHomeTempateModel *templateModel; // @synthesize templateModel;
@property(nonatomic) id <JDNJAdViewDelegate> adviewDelegate; // @synthesize adviewDelegate=_adviewDelegate;
