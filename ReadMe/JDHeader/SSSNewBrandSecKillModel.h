...
@class NSArray, NSNumber, NSString, SSSJumpModel, SSSNewBrandBackJumpModel, SSSNewBrandKillBrandShareModel, SSSpikeGoodsCouponModel;
...
@interface SSSNewBrandSecKillModel : SecKillBaseModel
{
    ...
    SSSNewBrandBackJumpModel *_backJump;
    long long _tabIndex;
...
@property(retain, nonatomic) SSSNewBrandBackJumpModel *backJump; // @synthesize backJump=_backJump;
