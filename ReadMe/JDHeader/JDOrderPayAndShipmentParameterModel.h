...
@class NSArray, NSDictionary, NSNumber, OrderPayShipAddressModel;
...
@interface JDOrderPayAndShipmentParameterModel : JDModel
{
    ...
    long long _presaleStepPay;
}

@property(nonatomic) long long presaleStepPay; // @synthesize presaleStepPay=_presaleStepPay;
