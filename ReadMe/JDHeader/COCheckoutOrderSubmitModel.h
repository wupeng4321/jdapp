...
@class COCheckoutSubmitOrderModel, NSArray, NSNumber, NSString;

@interface COCheckoutOrderSubmitModel : JDModel
{
    _Bool _inputPassword;
    COCheckoutSubmitOrderModel *_submitOrder;
    NSString *_coMsg;
    NSNumber *_onlinePay;
...
@property(retain, nonatomic) COCheckoutSubmitOrderModel *submitOrder; // @synthesize submitOrder=_submitOrder;
- (void).cxx_destruct;
