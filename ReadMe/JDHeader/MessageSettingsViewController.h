...
@class JDStoreNetwork, NSArray, NSString, SubScribMessageTypeModel, UIButton, UITableView;
...
@interface MessageSettingsViewController : JDViewController <UITableViewDelegate, UITableViewDataSource, JDBaseToastViewDelegate, MessageSettingCellDelegate, NewRefreshTableHeaderViewDelegate>
{
    ...
    SubScribMessageTypeModel *_soundModel;
}

@property(retain, nonatomic) SubScribMessageTypeModel *soundModel; // @synthesize soundModel=_soundModel;
...
- (void)clearMessageCenterRequest;
