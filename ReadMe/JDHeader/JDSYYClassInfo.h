...
@interface JDSYYClassInfo : NSObject
{
    _Bool _needUpdate;
    _Bool _isMeta;
    Class _cls;
    ...
    Class _metaCls;
    NSString *_name;
    JDSYYClassInfo *_superClassInfo;
...
@property(readonly, nonatomic) JDSYYClassInfo *superClassInfo; // @synthesize superClassInfo=_superClassInfo;
