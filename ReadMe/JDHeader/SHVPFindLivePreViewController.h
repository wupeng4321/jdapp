...
@class JDActivityIndicatorView, JDSHUnplGenerator, NSNumber, NSString, SHVPDataProvider, SHVPFindLivePreModel, SHVPFindLivePreView, SHVPLivePreRequest, SHVPLivePreSkuView, SHVPMainPageReminderView, UIView;
...
- (void)addPreSkuView;
- (void)followLiveShopWithShopId:(id)arg1;
