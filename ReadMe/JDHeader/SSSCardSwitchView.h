...
@protocol SSSCardSwitchViewDataSource, SSSCardSwitchViewDelegate;

@interface SSSCardSwitchView : UIView <UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout>
{
    double _dragStartX;
    double _dragEndX;
    _Bool _isDragScroll;
    ...
    id <SSSCardSwitchViewDelegate> _delegate;
    id <SSSCardSwitchViewDataSource> _dataSource;
...
@property(nonatomic) id <SSSCardSwitchViewDataSource> dataSource; // @synthesize dataSource=_dataSource;
@property(nonatomic) id <SSSCardSwitchViewDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
