...
@class FSDepthSkuModel, FSSHomeFitRequest, FinalSearchListFooterView, JDButton, NSMutableArray, NSString, UITableView;
@protocol FSHomeFitViewControllerDelegate;

@interface FSSHomeFitViewController : JDViewController
{
    _Bool _isGetMore;
    _Bool _isLoading;
    _Bool _hasNextPage;
    ...
    _Bool _isFirstLoad;
    id <FSHomeFitViewControllerDelegate> _delegate;
    NSString *_hcCid3;
    NSString *_logid;
    UITableView *_tableView;
    FinalSearchListFooterView *_footerView;
    NSMutableArray *_dataArray;
    FSSHomeFitRequest *_homeFitDao;
...
@property(retain, nonatomic) FSSHomeFitRequest *homeFitDao; // @synthesize homeFitDao=_homeFitDao;
...
@property(nonatomic) __weak id <FSHomeFitViewControllerDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
