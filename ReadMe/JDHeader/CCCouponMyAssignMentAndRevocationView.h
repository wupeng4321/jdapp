...
@class BJMarketCouponModel, CCMarketCouponViewModel, JDImageView, NSString, UIButton, UIImageView, UILabel;
...
- (void)hide;
- (void)show;
- (void)updateCouponInfoWithItem:(id)arg1 actionBlock:(CDUnknownBlockType)arg2;
- (void)removeView;
