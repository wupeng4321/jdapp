...
#import "MyJdStoryFloorViewDelegate-Protocol.h"
...
@interface MyJdStoryFloor : MyJdBaseFloor <MyJdStoryFloorViewDelegate, MyJdCardFloorHeaderViewDelegate, MyJdCardFloorFooterDelegate, MyJdFloorManagerViewDelegate, JDBaseToastViewDelegate, MyJdPromotionFloorViewDelegate>
{
    ...
    NSMutableArray *_myStoryArr;
    NSMutableArray *_myStoryTopicArr;
...
@property(retain, nonatomic) NSMutableArray *myStoryTopicArr; // @synthesize myStoryTopicArr=_myStoryTopicArr;
@property(retain, nonatomic) NSMutableArray *myStoryArr; // @synthesize myStoryArr=_myStoryArr;
