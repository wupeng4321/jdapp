...
@class FinderAttentionVideoProgressView, UIButton, UILabel;

@interface FinderAttentionVideoControlView : UIView
{
    ...
    FinderAttentionVideoProgressView *_progressView;
    UIView *_coverView;
    UIButton *_playBtn;
}
...
@property(retain, nonatomic) FinderAttentionVideoProgressView *progressView; // @synthesize progressView=_progressView;
