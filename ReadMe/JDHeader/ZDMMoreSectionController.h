...
@property(readonly, nonatomic) NSString *articleChannel; // @synthesize articleChannel=_articleChannel;
...
- (id)initWithSubmodule:(long long)arg1 articleChannel:(id)arg2;
