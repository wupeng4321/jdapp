...
@protocol SCShopCartCardGiftViewDelegate;

@interface SCShopCartCardGiftView : UIView <UIActionSheetDelegate>
{
    ...
    _Bool isNoStock;
    UIImage *giftIconImg;
    id <SCShopCartCardGiftViewDelegate> _delegate;
...
@property(nonatomic) __weak id <SCShopCartCardGiftViewDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
