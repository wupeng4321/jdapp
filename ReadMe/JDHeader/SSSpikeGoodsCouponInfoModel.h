...
@class NSAttributedString, NSString, SSSpikeGoodsCouponDetailModel;

@interface SSSpikeGoodsCouponInfoModel : NSObject
{
    NSString *_moduleId;
    NSString *_moduleStatus;
    NSString *_canUserGet;
    NSString *_canUserNowGet;
    SSSpikeGoodsCouponDetailModel *_award;
...
@property(retain, nonatomic) SSSpikeGoodsCouponDetailModel *award; // @synthesize award=_award;
