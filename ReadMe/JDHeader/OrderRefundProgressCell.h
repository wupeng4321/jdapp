...
@class NSIndexPath, NSString, OrderRefundProgressCellLeftView, TTTAttributedLabel, UIImageView, UILabel;
@protocol OrderRefundProgressCellDelegate;

@interface OrderRefundProgressCell : UITableViewCell <TTTAttributedLabelDelegate>
{
    _Bool _isLastRow;
    id <OrderRefundProgressCellDelegate> _delegate;
    UIImageView *_separateLine;
    TTTAttributedLabel *_progressMessageLabel;
    UILabel *_progressTimeLabel;
    OrderRefundProgressCellLeftView *_headerIcon;
    NSIndexPath *_indexPath;
}

@property(nonatomic) _Bool isLastRow; // @synthesize isLastRow=_isLastRow;
@property(retain, nonatomic) NSIndexPath *indexPath; // @synthesize indexPath=_indexPath;
@property(retain, nonatomic) OrderRefundProgressCellLeftView *headerIcon; // @synthesize headerIcon=_headerIcon;
...
@property(nonatomic) __weak id <OrderRefundProgressCellDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
