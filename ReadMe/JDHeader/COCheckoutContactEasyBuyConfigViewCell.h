...
@class JDButton, JDSegmentedView, NSString, UIButton, UILabel, UIView;

@interface COCheckoutContactEasyBuyConfigViewCell : UITableViewCell <JDSegmentedViewDelegate>
{
...
+ (double)getPickNameLabelHeightWithText:(id)arg1;
+ (double)heightOfChooseSiteDisplay:(_Bool)arg1 pickNameString:(id)arg2;
@property(retain, nonatomic) UILabel *pickNameLabel; // @synthesize pickNameLabel=_pickNameLabel;
