...
@interface FSSearchHotTagModel : JDModel
{
    int _tagType;
    ...
    long long _tiledIndex;
}

@property(nonatomic) long long tiledIndex; // @synthesize tiledIndex=_tiledIndex;
...
@property(copy, nonatomic) NSString *currentKeyName; // @synthesize currentKeyName=_currentKeyName;
