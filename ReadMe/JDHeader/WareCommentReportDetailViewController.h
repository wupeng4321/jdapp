...
@class JDButton, NSString, UIButton, UITableView, UIView, WareCommentNetworkManager, WareCommentReportModel;

@interface WareCommentReportDetailViewController : JDViewController <WareCommentReportDetailCellDelegate, SOZoomInTransitionAnimationContextDelegate>
{
