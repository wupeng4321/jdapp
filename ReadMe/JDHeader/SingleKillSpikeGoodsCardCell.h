...
@class JDImageView, SSSpikeGoodsBBuyLabel, SingleKillSpikeGoodsProductModel, UILabel;

@interface SingleKillSpikeGoodsCardCell : UICollectionViewCell
{
    ...
    SSSpikeGoodsBBuyLabel *_bBuyLabel1;
    SSSpikeGoodsBBuyLabel *_bBuyLabel2;
    UILabel *_priceLabel;
...
@property(retain, nonatomic) SSSpikeGoodsBBuyLabel *bBuyLabel2; // @synthesize bBuyLabel2=_bBuyLabel2;
@property(retain, nonatomic) SSSpikeGoodsBBuyLabel *bBuyLabel1; // @synthesize bBuyLabel1=_bBuyLabel1;
