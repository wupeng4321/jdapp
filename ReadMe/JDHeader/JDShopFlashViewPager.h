...
@class CacheNetworkManager, JDNJHomeTempateModel, JDPageControl, JDShopFlashPromotionModel, NSArray, NSString, NSTimer, iCarousel;
@protocol FlashProductViewDelegate;
