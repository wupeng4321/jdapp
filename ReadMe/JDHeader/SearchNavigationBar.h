...
@property(retain, nonatomic) UIControl *doorView; // @synthesize doorView=_doorView;
...
- (void)reloadNavigationBarIconWithColorType:(id)arg1 scanImage:(id)arg2;
- (void)searchBarIconTypeChange:(id)arg1;
- (void)audioButtonClick;
- (void)longPress:(id)arg1;
- (void)handleTap:(id)arg1;
- (void)showSecondLevelPageStyle:(_Bool)arg1;
- (void)updatePlaceHolderText;
- (void)cameraButtonClick;
- (void)handleAudioButtonShowNotification:(id)arg1;
- (struct CGRect)_getNavRightItemFrame;
- (struct CGRect)_getNavLeftItemFrame;
- (void)createUI;
