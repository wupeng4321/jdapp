...
@protocol COCheckoutOrderInfoCheckoutBarDelegate;

@interface COCheckoutOrderInfoCheckoutBar : UIImageView
{
    UIButton *checkoutBt_;
    UILabel *price_;
    UILabel *iousPayLabel_;
    id <COCheckoutOrderInfoCheckoutBarDelegate> _delegate;
}

@property(nonatomic) __weak id <COCheckoutOrderInfoCheckoutBarDelegate> delegate; // @synthesize delegate=_delegate;
