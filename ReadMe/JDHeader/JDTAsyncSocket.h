...
@class JDTAsyncSocketPreBuffer, JDTGCDAsyncReadPacket, JDTGCDAsyncWritePacket, NSData, NSMutableArray, NSString, NSURL;
@protocol JDTAsyncSocketDelegate, OS_dispatch_queue, OS_dispatch_source;

@interface JDTAsyncSocket : NSObject
{
    unsigned int flags;
    unsigned short config;
    id <JDTAsyncSocketDelegate> delegate;
...
@property __weak id <JDTAsyncSocketDelegate> delegate;
