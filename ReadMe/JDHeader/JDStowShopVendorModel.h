...
@class JDStowPromotionTabModel, JDStowShopActivityModel, NSArray, NSDictionary, NSNumber, NSString;
...
@interface JDStowShopVendorModel : JDModel
{
    ...
    JDStowPromotionTabModel *_promotionTab;
...
@property(retain, nonatomic) JDStowPromotionTabModel *promotionTab; // @synthesize promotionTab=_promotionTab;
