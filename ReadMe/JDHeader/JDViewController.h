...
@class JDButton, JDNavigationBar, JDPromptView, JDStatusView, NSArray, NSDate, NSDictionary, NSNumber, NSString, NoNetworkPromptView, UIButton;

@interface JDViewController : UIViewController <UITableViewDelegate, UITableViewDataSource>
{
    ...
    UIButton *_JDUiktBackBtn;
}

@property(retain, nonatomic) UIButton *JDUiktBackBtn; // @synthesize JDUiktBackBtn=_JDUiktBackBtn;
...
- (void)setBackButtonImage:(id)arg1 forState:(unsigned long long)arg2;
...
- (void)recordPV;
- (void)viewAnimation:(id)arg1 fromPoint:(struct CGPoint)arg2 toPoint:(struct CGPoint)arg3 RotationFromAngle:(double)arg4 toAngle:(double)arg5 opacityFromValue:(double)arg6 toValue:(double)arg7 duration:(double)arg8 completion:(CDUnknownBlockType)arg9;
- (void)startAnimationWithTotal:(long long)arg1 currentNum:(long long)arg2 animation:(_Bool)arg3 success:(CDUnknownBlockType)arg4;
- (void)startAnimationWithTotal:(long long)arg1 currentNum:(long long)arg2 animation:(_Bool)arg3 animateDuration:(double)arg4 success:(CDUnknownBlockType)arg5;
- (void)backTopButtonPressed:(id)arg1;
- (void)hideDigitalButtonAnimation:(_Bool)arg1 success:(CDUnknownBlockType)arg2;
- (void)hideBackTopButtonAnimation:(_Bool)arg1;
- (void)showDigitalButtonAnimation:(_Bool)arg1 success:(CDUnknownBlockType)arg2;
- (void)showBackTopButtonAnimation:(_Bool)arg1;
- (void)showDigitalButtonWithTotalNum:(long long)arg1 startNum:(long long)arg2;
- (void)removeDigitalButton;
- (void)removeBackTopButton;
- (void)createDigitalButton;
- (void)createBackTopButtonInView:(id)arg1 frame:(struct CGRect)arg2;
@property(nonatomic) _Bool backTopButtonAutoFront;
- (_Bool)digitalIsHidden;
- (void)setDigitalIsHidden:(_Bool)arg1;
- (double)lastTimeStamp;
- (void)setLastTimeStamp:(double)arg1;
- (_Bool)buttonAnimateCompleted;
- (void)setButtonAnimateCompleted:(_Bool)arg1;
- (long long)lastNum;
- (void)setLastNum:(long long)arg1;
- (_Bool)animateCompleted;
- (void)setAnimateCompleted:(_Bool)arg1;
- (id)separatorView;
- (void)setSeparatorView:(id)arg1;
- (id)rollLabelB;
- (void)setRollLabelB:(id)arg1;
- (id)rollLabelA;
- (void)setRollLabelA:(id)arg1;
- (id)totalLabel;
- (void)setTotalLabel:(id)arg1;
- (id)digitalButton;
- (void)setDigitalButton:(id)arg1;
@property(retain, nonatomic) JDButton *backTopButton;
- (void)animationDidStop:(id)arg1 finished:(_Bool)arg2;
- (void)bezierAnimation:(struct CGRect)arg1 fromPoint:(struct CGPoint)arg2 toPoint:(struct CGPoint)arg3 key:(id)arg4;
- (void)dropAnimationWithImage:(id)arg1 fromView:(id)arg2 toView:(id)arg3 inView:(id)arg4 key:(id)arg5;
...
- (void)doPushAnimationWithImageView:(id)arg1 finishedBlock:(CDUnknownBlockType)arg2;
- (_Bool)isAnimatiing;
- (void)setIsAnimatiing:(_Bool)arg1;
