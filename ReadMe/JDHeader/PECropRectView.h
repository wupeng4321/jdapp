...
#import "PEResizeControlViewDelegate-Protocol.h"

@class NSString, PEResizeControl, UIImage;
...
@interface PECropRectView : UIView <PEResizeControlViewDelegate>
{
    ...
    PEResizeControl *_pinchView;
    UIImage *_imgAcr;
    UIImage *_imgAcrFromCustomer;
    double _fixedAspectRatio;
    PEResizeControl *_viewFigerTouching;
    struct CGRect _constraintsForCrop;
    struct CGRect _initialRect;
}

@property(nonatomic) __weak PEResizeControl *viewFigerTouching; // @synthesize viewFigerTouching=_viewFigerTouching;
...
@property(retain, nonatomic) UIImage *imgAcrFromCustomer; // @synthesize imgAcrFromCustomer=_imgAcrFromCustomer;
@property(retain, nonatomic) UIImage *imgAcr; // @synthesize imgAcr=_imgAcr;
@property(retain, nonatomic) PEResizeControl *pinchView; // @synthesize pinchView=_pinchView;
...
@property(nonatomic) struct CGRect constraintsForCrop; // @synthesize constraintsForCrop=_constraintsForCrop;
...
- (id)initWithFrame:(struct CGRect)arg1 andEdgeAngleView:(CDUnknownBlockType)arg2;
- (id)initWithFrame:(struct CGRect)arg1;
- (id)initWithEdgeAngleView:(CDUnknownBlockType)arg1;
- (void)p_addWhiteCircle:(id)arg1;
- (id)p_getACornerWithBounds:(struct CGRect)arg1;
