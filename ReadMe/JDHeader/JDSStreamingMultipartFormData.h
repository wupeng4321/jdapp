...
#import "JDSMultipartFormData-Protocol.h"

@class JDSMultipartBodyStream, NSMutableURLRequest, NSString;

@interface JDSStreamingMultipartFormData : NSObject <JDSMultipartFormData>
{
    NSMutableURLRequest *_request;
    unsigned long long _stringEncoding;
    NSString *_boundary;
    JDSMultipartBodyStream *_bodyStream;
}

@property(retain, nonatomic) JDSMultipartBodyStream *bodyStream; // @synthesize bodyStream=_bodyStream;
