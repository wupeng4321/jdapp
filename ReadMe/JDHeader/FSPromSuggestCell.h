...
@class CALayer, FSPromSuggestModel, UILabel;

@interface FSPromSuggestCell : UITableViewCell
{
    FSPromSuggestModel *_item;
...
@property(retain, nonatomic) FSPromSuggestModel *item; // @synthesize item=_item;
- (void).cxx_destruct;
- (void)layoutSubviews;
