...
@class BrandKillBackJumpModel, BrandKillBrandShareModel, NSArray, NSNumber, NSString;
...
@interface BrandKillBrandModel : SecKillBaseModel
{
    ...
    NSString *_backImg;
    BrandKillBackJumpModel *_backJump;
...
@property(retain, nonatomic) BrandKillBackJumpModel *backJump; // @synthesize backJump=_backJump;
