...
@class COCheckoutBeanModel, JDBeanEditTextField, NSNumber, NSString, UIButton, UILabel, UIView;
@protocol JDBeanEditViewDelegate;
...
- (struct CGSize)sizeTextWithString:(id)arg1 withFont:(double)arg2 constrainedWithWidth:(double)arg3;
- (void)freshView;
