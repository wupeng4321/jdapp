...
@class JDImageView, NSMutableArray, NSString, NSTimer, SHVPAnchorTipsView, SHVPAttentionToastView, SHVPAuthorHeadView, SHVPBoneRuleView, SHVPCommentView, SHVPCoreCommentView, SHVPCouponView, SHVPCustomActivityView, SHVPDataProvider, SHVPGiftBoardView, SHVPGiftButtonView, SHVPGiftFullGifView, SHVPGiftHitView, SHVPHitLikedAnimationView, SHVPHorizonShareView, SHVPLikedAnimationController, SHVPLotteryView, SHVPMainPageAddCommentView, SHVPMainPageAnchorInfoView, SHVPMainPageButtonView, SHVPMainPageCommentTableViewDelegate, SHVPMainPageNewProductView, SHVPMainPageProductView, SHVPMainPageReminderView, SHVPMainPageReplayBar, SHVPMainPageSkuView, SHVPMainPageViewController, SHVPMainPageViewerHeaderView, SHVPReloadNetView, SHVPRequestShareView, SHVPToastBindPhoneView, SHVPXViewUtil, UIButton, UIImageView, UILabel, UIScrollView, UITapGestureRecognizer, UIView;

@interface SHVPMainPageHorizontalViewController : JDViewController <SHVPDanmuSDKDelegate, SHVPLivingPlayerDelegate, JDBaseToastViewDelegate>
{
...
- (void)dismissHorizontalViewControllerAnimated:(_Bool)arg1 isNormalExit:(_Bool)arg2 isNeedLogin:(_Bool)arg3 completion:(CDUnknownBlockType)arg4;
