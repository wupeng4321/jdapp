...
@class FinderArticleCommentView, FinderArticleDetailCaptchaInfo, FinderArticleDetailFirstLevelCommentModel, FinderCommentDetailDataModel, FinderTabBar, JDStoreNetwork, NSString, NewFinderNetworkProvider, UIAlertController, UITableView;
...
@property(nonatomic) _Bool isSelfDelete; // @synthesize isSelfDelete=_isSelfDelete;
