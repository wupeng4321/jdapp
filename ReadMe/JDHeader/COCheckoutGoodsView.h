...
@class COCheckoutGoodsViewLayout, JDImageView, UILabel;

@interface COCheckoutGoodsView : JDView
{
    ...
    COCheckoutGoodsViewLayout *_layout;
}

@property(retain, nonatomic) COCheckoutGoodsViewLayout *layout; // @synthesize layout=_layout;
