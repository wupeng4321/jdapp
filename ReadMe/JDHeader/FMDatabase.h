...
- (id)getCommonBodyStringWithDictionary:(id)arg1;
- (void)postErrorMTAWithSQLString:(id)arg1 className:(id)arg2 functionId:(id)arg3 force:(_Bool)arg4;
- (void)postErrorMTAWithSQLString:(id)arg1 className:(id)arg2 functionId:(id)arg3;
