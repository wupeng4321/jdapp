...
#import "JDXBTTTAttributedLabel-Protocol.h"
#import "UIGestureRecognizerDelegate-Protocol.h"

@class JDXBTTTAttributedLabelLink, NSArray, NSAttributedString, NSDataDetector, NSDictionary, NSString, UIColor, UILongPressGestureRecognizer;
@protocol JDXBTTTAttributedLabelDelegate;

@interface JDXBTTTAttributedLabel : UILabel <JDXBTTTAttributedLabel, UIGestureRecognizerDelegate>
{
    ...
    id <JDXBTTTAttributedLabelDelegate> _delegate;
    ...
    NSArray *_linkModels;
    JDXBTTTAttributedLabelLink *_activeLink;
...
@property(retain, nonatomic) JDXBTTTAttributedLabelLink *activeLink; // @synthesize activeLink=_activeLink;
...
@property(nonatomic) id <JDXBTTTAttributedLabelDelegate> delegate; // @synthesize delegate=_delegate;
