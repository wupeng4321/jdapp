...
@class ChooseShipmentTypeView, JDOrderPayAndShipmentEditModel, JDOrderPayAndShipmentParameterModel, JDStoreNetwork, NSString, UIButton, UITableView, pickShipmentModel;

@interface ShipmentTypeViewController : COCheckoutAbstractViewController <PayAndShipLayoutDelegate>
{
