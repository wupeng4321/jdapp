...
@class COCheckoutBeanModel, COCheckoutRuleToastView, NSNumber, UIButton, UILabel, UIView;
@protocol JDBeanNewRuleEditViewDelegate;

@interface NewRuleBeanEditView : OrderVirtualBaseView
{
    UIButton *_arrowBtn;
    UIButton *_rulesBtn;
    UIView *_bottomLine;
