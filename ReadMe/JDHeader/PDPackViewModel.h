...
@class NSString, NewProductModel, PDPackView;

@interface PDPackViewModel : PDFloorBaseViewModel <PDFloorViewProtocol>
{
    PDPackView *_packView;
    NewProductModel *_model;
}

+ (void)load;
@property(retain, nonatomic) NewProductModel *model; // @synthesize model=_model;
@property(retain, nonatomic) PDPackView *packView; // @synthesize packView=_packView;
- (void).cxx_destruct;
- (void)expoSpecial;
