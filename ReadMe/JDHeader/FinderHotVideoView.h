...
@class FinderHotVideoControlView, JDImageView, NSString, SHAVErrorTipView, SHAVFinishedView, SHAVPlayerActivityView, SHAVToastView, UITapGestureRecognizer;
@protocol VBVideoViewDelegate;

@interface FinderHotVideoView : UIView <VBVideoViewProtocol>
{
    ...
    FinderHotVideoControlView *_controlView;
...
@property(retain, nonatomic) FinderHotVideoControlView *controlView; // @synthesize controlView=_controlView;
