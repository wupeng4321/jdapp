...
@class JDButton, JDImageView, JDStoreNetwork, NSArray, NSDictionary, NSMutableArray, NSMutableDictionary, NSString, ShareOrderAssetProduct, ShareOrderCommentWareInfoModel, ShareOrderFooterView, ShareOrderHeaderView, ShareOrderPCCommentDataModel, ShareOrderProduct, ShareOrderPublishOrderManager, ShareOrderUploadVideo, UIBarButtonItem, UICollectionView, UIImageView, UILabel, UIView;

@interface ShareOrderBaseViewController : JDViewController <ShareOrderPublishOrderManagerDelegate, JDBaseToastViewDelegate, JDReloadViewDelegate, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, ShareOrderHeaderViewDelegate, ShareOrderFooterViewDelegate, UIGestureRecognizerDelegate, UIActionSheetDelegate, JDVideoRecorderControllerDelegate, ShareOrderUploadVideoDelegate, JDVideoEditorControllerDelegate, SOZoomInTransitionAnimationContextDelegate, JDImageEditorControllerDelegate>
{
