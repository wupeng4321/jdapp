...
@protocol DJXYCollectionViewDelegateWaterfallLayout;

@interface DJXYCollectionViewWaterfallLayout : UICollectionViewLayout
{
    ...
    id <DJXYCollectionViewDelegateWaterfallLayout> _delegate;
...
@property(nonatomic) __weak id <DJXYCollectionViewDelegateWaterfallLayout> delegate; // @synthesize delegate=_delegate;
