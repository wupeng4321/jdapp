...
#import "JDPAttributedLabel-Protocol.h"
#import "UIGestureRecognizerDelegate-Protocol.h"

@class JDPAttributedLabelLink, NSArray, NSAttributedString, NSDataDetector, NSDictionary, NSString, UIColor, UILongPressGestureRecognizer;
@protocol JDPAttributedLabelDelegate;

@interface JDPAttributedLabel : UILabel <JDPAttributedLabel, UIGestureRecognizerDelegate>
{
    ...
    id <JDPAttributedLabelDelegate> _delegate;
    ...
    NSArray *_linkModels;
    JDPAttributedLabelLink *_activeLink;
...
@property(retain, nonatomic) JDPAttributedLabelLink *activeLink; // @synthesize activeLink=_activeLink;
...
@property(nonatomic) id <JDPAttributedLabelDelegate> delegate; // @synthesize delegate=_delegate;
