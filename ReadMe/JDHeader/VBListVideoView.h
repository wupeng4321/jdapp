...
@class JDImageView, NSString, SHAVErrorTipView, SHAVFinishedView, SHAVPlayerActivityView, SHAVToastView, UITapGestureRecognizer, VBListVideoControlView;
@protocol VBVideoViewDelegate;

@interface VBListVideoView : UIView <VBVideoViewProtocol>
{
    _Bool _interactiveEnabled;
    UIView *_videoView;
    id <VBVideoViewDelegate> _viewDelegate;
    NSString *_durationString;
    VBListVideoControlView *_controlView;
...
@property(retain, nonatomic) VBListVideoControlView *controlView; // @synthesize controlView=_controlView;
