...
@class FSSPromGiftModel, JDImageView, JDPriceLabel, UIImageView, UILabel;

@interface FSPromotionJJGCell : UITableViewCell
{
    _Bool _hasSelected;
    FSSPromGiftModel *_giftModel;
...
@property(retain, nonatomic) FSSPromGiftModel *giftModel; // @synthesize giftModel=_giftModel;
- (void).cxx_destruct;
- (void)tipImgTap;
