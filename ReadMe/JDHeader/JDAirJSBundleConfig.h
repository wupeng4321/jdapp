...
@property(retain, nonatomic) NSDictionary *debugParams; // @synthesize debugParams=_debugParams;
@property(retain, nonatomic) NSDictionary *params; // @synthesize params=_params;
@property(nonatomic) long long taskState; // @synthesize taskState=_taskState;
@property(nonatomic) _Bool forceRn; // @synthesize forceRn=_forceRn;
