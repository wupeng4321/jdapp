...
@class JDSNetworkReachabilityManager, JDSSecurityPolicy, NSArray, NSLock, NSMutableDictionary, NSOperationQueue, NSString, NSURLSession, NSURLSessionConfiguration;
@protocol JDSURLResponseSerialization, OS_dispatch_group, OS_dispatch_queue;

@interface JDSURLSessionManager : NSObject <NSURLSessionDelegate, NSURLSessionTaskDelegate, NSURLSessionDataDelegate, NSURLSessionDownloadDelegate, NSSecureCoding, NSCopying>
{
    _Bool _attemptsToRecreateUploadTasksForBackgroundSessions;
    NSURLSession *_session;
    NSOperationQueue *_operationQueue;
    id <JDSURLResponseSerialization> _responseSerializer;
    JDSSecurityPolicy *_securityPolicy;
    JDSNetworkReachabilityManager *_reachabilityManager;
...
@property(retain, nonatomic) JDSNetworkReachabilityManager *reachabilityManager; // @synthesize reachabilityManager=_reachabilityManager;
@property(retain, nonatomic) JDSSecurityPolicy *securityPolicy; // @synthesize securityPolicy=_securityPolicy;
@property(retain, nonatomic) id <JDSURLResponseSerialization> responseSerializer; // @synthesize responseSerializer=_responseSerializer;
