...
@class NSString, UIButton, UIImageView, UILabel, UITextView, UIWindow, VersionInfoModel;
...
@property(copy, nonatomic) NSString *currentNetType; // @synthesize currentNetType=_currentNetType;
