...
@interface PDCommonAView : PDFloorBaseView
{
    ...
    NSDictionary *_data;
    JDImageView *_iconV_center;
    JDImageView *_iconV_tail;
}

@property(retain, nonatomic) JDImageView *iconV_tail; // @synthesize iconV_tail=_iconV_tail;
@property(retain, nonatomic) JDImageView *iconV_center; // @synthesize iconV_center=_iconV_center;
...
- (void).cxx_destruct;
- (void)resetState;
- (void)doLayoutWithIcon:(id)arg1 midIcon:(id)arg2 tailIcon:(id)arg3;
- (void)downloadImages;
