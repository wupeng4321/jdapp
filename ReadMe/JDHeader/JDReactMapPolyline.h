...
@class JDReactMap, NSArray, NSString, QOverlayPathView, QPolyline, UIColor;

@interface JDReactMapPolyline : QAnnotationView <QOverlay>
{
    int _lineCap;
    int _lineJoin;
    JDReactMap *_map;
    QPolyline *_polyline;
    QOverlayPathView *_renderer;
...
@property(retain, nonatomic) QOverlayPathView *renderer; // @synthesize renderer=_renderer;
...
- (void).cxx_destruct;
- (void)drawToContext:(struct CGContext *)arg1;
