...
#import "FinderVideoBuyBaseModel.h"

@class FinderTabBarCommentItemModel, FinderTabBarStoreItemModel, NSArray, NSDictionary, NSMutableArray, NSNumber, NSString;

@interface FinderVideoBuyListModel : FinderVideoBuyBaseModel
{
    NSString *_authorId;
...
@property(retain, nonatomic) NSMutableArray *floatSkuArray; // @synthesize floatSkuArray=_floatSkuArray;
