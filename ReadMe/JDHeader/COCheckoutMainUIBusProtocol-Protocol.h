...
@protocol COCheckoutMainUIBusProtocol <NSObject>
...
- (void)presentChooseViewWithParams:(NSDictionary *)arg1;
- (void)pushToShippingViewControllerWithParams:(NSDictionary *)arg1;
- (void)pushToCartItemsViewControllerWithVenderId:(NSString *)arg1;
