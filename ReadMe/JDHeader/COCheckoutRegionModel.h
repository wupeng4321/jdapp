...
@interface COCheckoutRegionModel : JDModel
{
    COCheckoutRegionModel *_superRegion;
    COCheckoutRegionModel *_nextRegion;
    NSNumber *_ID;
    NSString *_name;
    NSString *_areaCode;
    NSString *_nameCode;
...
@property(retain, nonatomic) COCheckoutRegionModel *nextRegion; // @synthesize nextRegion=_nextRegion;
@property(retain, nonatomic) COCheckoutRegionModel *superRegion; // @synthesize superRegion=_superRegion;
- (void).cxx_destruct;
