...
@interface IAMainSessionGrowthModel : NSObject <IAMainSessionModelDelegate>
{
...
+ (id)routerHandle_IAMainSessionGrowthModel_construct:(id)arg1 callback:(CDUnknownBlockType)arg2;
