...
@interface TTTHeadTabPurePicBtnContentView : UIView
{
    _Bool _downloadImgFailed;
    _Bool _selected;
    UILabel *_titleLabel;
...
@property(nonatomic) _Bool downloadImgFailed; // @synthesize downloadImgFailed=_downloadImgFailed;
...
- (void).cxx_destruct;
- (void)downLoadImgFailed:(_Bool)arg1;
