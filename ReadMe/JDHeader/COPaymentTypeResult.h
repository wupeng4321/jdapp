...
@class COCheckoutElementNameConfig, COCheckoutNotifyRM, NSArray, NSString;
...
@property(retain, nonatomic) COCheckoutElementNameConfig *elementNameMap; // @dynamic elementNameMap;
