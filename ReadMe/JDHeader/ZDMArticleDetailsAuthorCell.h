...
@class JDImageView, NSLayoutConstraint, UIButton, UILabel, UIView;
...
@interface ZDMArticleDetailsAuthorCell : UICollectionViewCell
{
    ...
    NSLayoutConstraint *_seperatorLineWidth;
    UILabel *_authorDesLabel;
...
@property(retain, nonatomic) UILabel *authorDesLabel; // @synthesize authorDesLabel=_authorDesLabel;
@property(retain, nonatomic) NSLayoutConstraint *seperatorLineWidth; // @synthesize seperatorLineWidth=_seperatorLineWidth;
