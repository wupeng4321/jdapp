...
@protocol JDVFFaceDelegate;

@interface JDVFFaceViewController : JDViewController <UINavigationControllerDelegate, UIImagePickerControllerDelegate, JDBaseToastViewDelegate>
{
    ...
    int _genderType;
    id <JDVFFaceDelegate> _delegate;
}

@property(nonatomic) int genderType; // @synthesize genderType=_genderType;
@property(nonatomic) __weak id <JDVFFaceDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
- (void)setSku:(id)arg1;
