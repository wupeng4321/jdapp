...
@class JDPaymentCodeAucSendMsgDisplayInfoMoel, JDPaymentCodeBankCardInfoModel, NSString;

@interface JDPaymentCodeCaptchaViewParam : JDPayModel
{
    _Bool _verifyVC;
    NSString *_message;
...
@property(nonatomic) _Bool verifyVC; // @synthesize verifyVC=_verifyVC;
