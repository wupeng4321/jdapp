...
@interface CategoryPromotionModel : NSObject
{
    ...
    NSString *_testId3;
    NSString *_testId4;
    NSString *_styleTypeBanner;
    NSArray *_cmsMonthCardList;
}

+ (id)objectClassInArray;
@property(retain, nonatomic) NSArray *cmsMonthCardList; // @synthesize cmsMonthCardList=_cmsMonthCardList;
@property(copy, nonatomic) NSString *styleTypeBanner; // @synthesize styleTypeBanner=_styleTypeBanner;
