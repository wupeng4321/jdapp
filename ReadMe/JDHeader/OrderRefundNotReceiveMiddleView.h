...
@class NSArray, OrderRefundModel, UIImageView, UILabel, UITextField;
@protocol OrderRefundNotReceiveMiddleViewDelegate;

@interface OrderRefundNotReceiveMiddleView : UIView
{
    id <OrderRefundNotReceiveMiddleViewDelegate> _delegate;
...
@property(nonatomic) __weak id <OrderRefundNotReceiveMiddleViewDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
