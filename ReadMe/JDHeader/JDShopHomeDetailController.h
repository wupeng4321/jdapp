...
@class JDShopCommonErrorView, JDShopDetailBottomView, JDShopDetailBrandView, JDShopDetailHeadView, JDShopDetailScoreView, JDShopModel, JDStoreNetwork, NSMutableDictionary, NSString, NSURL, UIScrollView, UIView;
...
- (id)initWithControllerWithShopId:(id)arg1 vendorId:(id)arg2;
- (void)dealloc;
