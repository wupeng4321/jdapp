...
@class NSArray, NSString, PDBPContainerDataModel, UIButton, UILabel, UITableView;

@interface PDBPYushouRulePopupView : JDCoreSemiPopupView <UITableViewDelegate, UITableViewDataSource, PDViewProtocol>
{
