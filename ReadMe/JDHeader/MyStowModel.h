...
@interface MyStowModel : JDModel
{
    ...
    NSString *_fsExclusivePrice;
    NSDictionary *_fsNoticePrice;
    NSString *_locShopId;
}
...
@property(retain, nonatomic) NSDictionary *fsNoticePrice; // @synthesize fsNoticePrice=_fsNoticePrice;
@property(copy, nonatomic) NSString *fsExclusivePrice; // @synthesize fsExclusivePrice=_fsExclusivePrice;
