...
@class CacheNetworkManager, JDPageControl, JDStoreNetwork, JDStoryHomeTempateModel, NSArray, NSString, NSTimer, iCarousel;
@protocol AdViewDelegate;

@interface JDStoryAdView : JDContentItem <iCarouselDataSource, iCarouselDelegate>
{
    ...
    JDStoryHomeTempateModel *_templateModel;
}

@property(retain, nonatomic) JDStoryHomeTempateModel *templateModel; // @synthesize templateModel=_templateModel;
