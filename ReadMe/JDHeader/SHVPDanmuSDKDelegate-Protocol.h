...
@class NSArray, NSError, NSMutableArray, NSString, SHVPDanmuSDK, SHVPNewLotteryItemModel;

@protocol SHVPDanmuSDKDelegate <NSObject>
- (void)sdk:(SHVPDanmuSDK *)arg1 receiveLottery:(SHVPNewLotteryItemModel *)arg2;
- (void)sdk:(SHVPDanmuSDK *)arg1 ReceiveLiveAnwserWithPrize:(NSString *)arg2 totalWithoutSelf:(NSString *)arg3 totalWinner:(NSString *)arg4 winners:(NSArray *)arg5 unit:(NSString *)arg6 cash:(NSString *)arg7 qNum:(NSString *)arg8;
- (void)sdk:(SHVPDanmuSDK *)arg1 ReceiveLiveAnwserWithQuestionId:(NSString *)arg2 answer:(NSString *)arg3 options:(NSArray *)arg4 key:(NSString *)arg5 optionNumStrs:(NSArray *)arg6 optionNums:(NSArray *)arg7 question:(NSString *)arg8;
- (void)sdk:(SHVPDanmuSDK *)arg1 ReceiveLiveQuestionWithQuestionId:(NSString *)arg2 question:(NSString *)arg3 options:(NSArray *)arg4;
- (void)sdk:(SHVPDanmuSDK *)arg1 ReceiveCouponWithAct:(NSString *)arg2 couponId:(NSString *)arg3 operation:(NSString *)arg4 quota:(NSString *)arg5 denomination:(NSString *)arg6;
- (void)sdk:(SHVPDanmuSDK *)arg1 EndActivityWithType:(NSString *)arg2;
- (void)sdk:(SHVPDanmuSDK *)arg1 StartActivityWithIimgUrl:(NSString *)arg2 xviewUrl:(NSString *)arg3;
...
- (void)sdk:(SHVPDanmuSDK *)arg1 AnchorSendGiftGiftId:(NSString *)arg2 giftName:(NSString *)arg3 giftGif:(NSString *)arg4 nickName:(NSString *)arg5 type:(NSString *)arg6 userHeadImg:(NSString *)arg7 giftType:(NSString *)arg8 giftFullGif:(NSString *)arg9 giftDuration:(double)arg10;
...
- (void)sdk:(SHVPDanmuSDK *)arg1 ClosedWithAddress:(NSString *)arg2 Error:(NSError *)arg3 Retrying:(_Bool)arg4 buryArr:(NSMutableArray *)arg5;
@end
