...
@class NSString, NewProductModel, PDColorSizeInfoModel, PDNetworkAccessManager, PDPackColorSizePopupView, UITableView;
...
- (void)generalProductAddCart:(id)arg1;
- (void)packProductAddDrugCart:(id)arg1;
