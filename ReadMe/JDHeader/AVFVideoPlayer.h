...
@protocol AVFVideoPlayerDelegate;

@interface AVFVideoPlayer : NSObject
{
    _Bool _playing;
    _Bool _looping;
    _Bool _scrubbing;
    ...
    id <AVFVideoPlayerDelegate> _delegate;
    AVPlayer *_player;
...
@property(nonatomic) __weak id <AVFVideoPlayerDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
