...
@class CommuneCategoryListCellModel, CommuneCategoryListProductView, JDImageView, UIImageView, UILabel, UIView;
...
@interface CommuneCategoryListCell : UITableViewCell
{
    ...
    JDImageView *_answeredSignView;
}

@property(retain, nonatomic) JDImageView *answeredSignView; // @synthesize answeredSignView=_answeredSignView;
