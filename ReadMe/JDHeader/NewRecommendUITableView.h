...
@class JDFooterLoadingView, JDImageView, JDNetwork, JDStoreNetwork, NSMutableArray, NSMutableDictionary, NSMutableString, NSString, NewRecommendItem, UIButton, UIView, UniformRecommendVideoPlayerManager;
@protocol RecommendUITableViewDataSource, RecommendUITableViewDelegate;

@interface NewRecommendUITableView : UITableView <RecommendNegativeDelegate, UITableViewDataSource, UITableViewDelegate, RecommendMenuCellDelegate>
{
    UIView *headView;
    ...
    NSMutableDictionary *reasonFloorlHeightDic;
    _Bool showHelp;
    ...
    NSMutableArray *reasonFloorArray;
    CDUnknownBlockType _tFinishBlock;
    CDUnknownBlockType _tCancelBlock;
    UniformRecommendVideoPlayerManager *_videoPlayerMgr;
    JDNetwork *_adNetwork;
...
@property(retain, nonatomic) JDNetwork *adNetwork; // @synthesize adNetwork=_adNetwork;
@property(retain, nonatomic) UniformRecommendVideoPlayerManager *videoPlayerMgr; // @synthesize videoPlayerMgr=_videoPlayerMgr;
...
@property(retain, nonatomic) NSMutableArray *reasonFloorArray; // @synthesize reasonFloorArray;
...
- (void)sendRecommendAdRequest:(id)arg1;
- (void)handleVideoAutoPlay;
- (void)jumpPublicTest;
- (id)viewController;
...
- (double)caculateCellHeightByItemModel:(id)arg1 isFloor:(_Bool)arg2;
...
- (void)finishBlockHandle:(id)arg1 andPageNumber:(long long)arg2 error:(id)arg3 isTab:(_Bool)arg4;
- (void)takeCouponVC:(id)arg1 andIndex:(int)arg2;
- (void)hideHelpImageView;
- (void)setupFootView;
- (void)setupPublicTestFootView;
- (void)setDownCellPostionYInWindow:(int)arg1;
- (void)setTopHeight:(int)arg1;
