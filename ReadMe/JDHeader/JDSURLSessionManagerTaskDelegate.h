...
@class JDSURLSessionManager, NSMutableData, NSProgress, NSString, NSURL;

@interface JDSURLSessionManagerTaskDelegate : NSObject <NSURLSessionTaskDelegate, NSURLSessionDataDelegate, NSURLSessionDownloadDelegate>
{
    JDSURLSessionManager *_manager;
...
@property(nonatomic) __weak JDSURLSessionManager *manager; // @synthesize manager=_manager;
- (void).cxx_destruct;
