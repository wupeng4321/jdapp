...
@class JDImageView, NSString, TTTPlusPriceView, TTTPriceCentreView, TTTRotaionView, TTTWareModel, TTTWaresMarkView, TTTWaresSimilarView, UIImageView, UILabel;
@protocol TTTWaresLHItemDelegate;

@interface TTTWaresLHItem : TTTBaseView <TTTBaseViewProtocol>
{
    id <TTTWaresLHItemDelegate> _delegate;
...
@property(nonatomic) __weak id <TTTWaresLHItemDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
