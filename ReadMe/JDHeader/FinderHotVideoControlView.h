...
@class FinderHotVideoProgressView, UIButton, UILabel;

@interface FinderHotVideoControlView : UIView
{
    ...
    FinderHotVideoProgressView *_progressView;
    UIView *_coverView;
    UIButton *_playBtn;
}
...
@property(retain, nonatomic) FinderHotVideoProgressView *progressView; // @synthesize progressView=_progressView;
