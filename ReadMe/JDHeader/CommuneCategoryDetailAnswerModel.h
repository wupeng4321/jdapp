...
@property(nonatomic) _Bool havePriase; // @synthesize havePriase=_havePriase;
...
@property(copy, nonatomic) NSString *expertIconId; // @synthesize expertIconId=_expertIconId;
