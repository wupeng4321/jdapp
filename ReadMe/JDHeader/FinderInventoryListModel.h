...
@class FinderFloatModel, FinderInventoryHeadPicModel, FinderJumpModel, NSArray, NSNumber, NSString;
...
@interface FinderInventoryListModel : NSObject
{
    ...
    NSString *_clk;
    FinderJumpModel *_searchJump;
}

@property(retain, nonatomic) FinderJumpModel *searchJump; // @synthesize searchJump=_searchJump;
