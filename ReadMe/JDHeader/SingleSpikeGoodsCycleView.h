...
@protocol SGCycleScrollViewDataSource, SGCycleScrollViewDelegate;

@interface SingleSpikeGoodsCycleView : UIView
{
    double _animationDuration;
    NSTimer *_animationTimer;
    _Bool _isDragging;
    int _type;
    id <SGCycleScrollViewDataSource> _dataSource;
    id <SGCycleScrollViewDelegate> _delegate;
...
@property(nonatomic) __weak id <SGCycleScrollViewDelegate> delegate; // @synthesize delegate=_delegate;
@property(nonatomic) __weak id <SGCycleScrollViewDataSource> dataSource; // @synthesize dataSource=_dataSource;
- (void).cxx_destruct;
