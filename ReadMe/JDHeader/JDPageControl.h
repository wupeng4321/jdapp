...
{
    _Bool _adjustsIndicatorSizeToFitImage;
    float _pageSpace;
...
@property(nonatomic) _Bool adjustsIndicatorSizeToFitImage; // @synthesize adjustsIndicatorSizeToFitImage=_adjustsIndicatorSizeToFitImage;
