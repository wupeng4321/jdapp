...
@interface JDPaymentCodeCertInfoModel : JDPayModel
{
    ...
    _Bool _isEditCertNum;
    _Bool _isShowCertNum;
...
@property(nonatomic) _Bool isShowCertNum; // @synthesize isShowCertNum=_isShowCertNum;
@property(nonatomic) _Bool isEditCertNum; // @synthesize isEditCertNum=_isEditCertNum;
