...
@class NSArray, NSString, ZDMShareInfoModel, ZDMUserViewModel;
...
@property(nonatomic) long long numberOfTotalPost; // @synthesize numberOfTotalPost=_numberOfTotalPost;
