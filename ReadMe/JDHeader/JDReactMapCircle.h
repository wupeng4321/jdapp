...
@class JDReactMap, NSArray, NSString, QCircle, QCircleView, UIColor;

@interface JDReactMapCircle : QAnnotationView <QOverlay>
{
    _Bool _radiusSet;
    _Bool _centerSet;
    int _lineCap;
...
@property(retain, nonatomic) QCircleView *renderer; // @synthesize renderer=_renderer;
@property(retain, nonatomic) QCircle *circle; // @synthesize circle=_circle;
