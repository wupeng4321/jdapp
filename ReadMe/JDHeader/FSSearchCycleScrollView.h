...
@protocol FSSearchCycleScrollViewDataSource, FSSearchCycleScrollViewDelegate;

@interface FSSearchCycleScrollView : UIView
{
    double _animationDuration;
    NSTimer *_animationTimer;
    _Bool _isDragging;
    id <FSSearchCycleScrollViewDataSource> _dataSource;
    id <FSSearchCycleScrollViewDelegate> _delegate;
...
@property(nonatomic) __weak id <FSSearchCycleScrollViewDelegate> delegate; // @synthesize delegate=_delegate;
@property(nonatomic) __weak id <FSSearchCycleScrollViewDataSource> dataSource; // @synthesize dataSource=_dataSource;
- (void).cxx_destruct;
